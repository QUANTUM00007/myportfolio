...
SECRET_KEY = 'django-insecure-ea33%xi+w&cvckm_0jr8@0**!hr-)b%_8=u*2t*zr-7qqn(w@h'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'portfolio.context_processors.current_year',  # Add this line
            ],
        },
    },
]
...
# EMAIL_BACKEND = 'portfolio.custom_backend_email.CustomEmailBackend'
